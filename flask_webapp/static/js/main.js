...
async function searchAddress(searchText){
	const url = "https://swiggy-menu-download.herokuapp.com/search?input=".concat(searchText)
...
async function getLatlong(placeid){
	const api = "https://swiggy-menu-download.herokuapp.com/geocode?placeid=" + placeid;
...
async function download(){
	...
	const api = "https://swiggy-menu-download.herokuapp.com/restaurants?lat=" + lat + "&long=" + long + "&offset=0";
	const res = await fetch(api);
